...
export default function YX1Eaphones() {
  return (
    <article className='w-full flex flex-col space-y-6 md:flex-row md:space-y-0 md:space-x-3 lg:space-x-[30px]'>
      <div className='home-yx1-earphones-bg w-full h-[200px] rounded-lg md:w-1/2 md:h-[320px]'></div>
      <div className='w-full h-[200px] pl-6 rounded-lg bg-mainGrey flex flex-col justify-center md:w-1/2 md:h-[320px] md:pl-[41px] lg:pl-[95px]'>
